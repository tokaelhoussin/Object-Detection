...
#clip1 = clip1.subclib(0, 30)
new = clip1.set_fps(18)
project_video_clip = new.fl_image(process_image)
%time project_video_clip.write_videofile(project_video_res, audio = False,logger=None)
